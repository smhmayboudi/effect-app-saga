...
export const SagaLogSchema = Schema.Struct({
  ...
  status: Schema.Literal("STARTED", "IN_PROGRESS", "COMPLETED", "FAILED", "COMPENSATING", "COMPENSATED")
    .annotations({ description: "Status" }), // default: STARTED
  steps: Schema.Array(Schema.Struct({
    ...
    status: Schema.Literal("PENDING", "IN_PROGRESS", "COMPLETED", "FAILED", "COMPENSATED")
      .annotations({ description: "Status" }), // default: PENDING
